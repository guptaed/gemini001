// lib/src/models/bank_history.dart
...
// BankHistory represents a historical record of bank details changes
class BankHistory {
  final String? id;              // Firestore document ID
  final int supId;               // Supplier ID
  final String documentId;       // Bank Firestore document ID
  ...
  // Convert BankHistory to Map for Firestore
  ...
  // Create BankHistory from Firestore DocumentSnapshot
  factory BankHistory.fromFirestore(
    ...
    try {
      ...
      logger.e('Error parsing bank history from Firestore: $e');
      rethrow;
    }
  }
  ...
  @override
  String toString() {
    return 'BankHistory(supId: $supId, timestamp: $timestamp, user: $userName, changes: ${changes.length})';
  }
}
