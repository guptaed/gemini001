// lib/src/models/contract_history.dart

// ignore_for_file: non_constant_identifier_names

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:vietfuel_shared/src/models/supplier_history.dart';
import 'package:vietfuel_shared/src/utils/logging.dart';

// ContractHistory represents a historical record of contract changes
class ContractHistory {
  final String? id;              // Firestore document ID
  final int supId;               // Supplier ID
  final String documentId;       // Contract Firestore document ID
  ...
  // Convert ContractHistory to Map for Firestore
  ...
  // Create ContractHistory from Firestore DocumentSnapshot
  factory ContractHistory.fromFirestore(
    ...
    try {
      ...
      logger.e('Error parsing contract history from Firestore: $e');
      rethrow;
    }
  }
  ...
  @override
  String toString() {
    return 'ContractHistory(supId: $supId, timestamp: $timestamp, user: $userName, changes: ${changes.length})';
  }
}
